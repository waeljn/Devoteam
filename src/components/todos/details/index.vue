              ...
              <div class="col-12">
                ...
                <div class="post">
                  <div class="user-block">
                    <img
                      ...
                      src="https://adminlte.io/themes/v3/dist/img/user1-128x128.jpguser1-128x128.jpg"
                      alt="user image"
                    />
                    <span class="username">
                ...
                <div class="post clearfix">
                  <div class="user-block">
                    <img
                      class="img-circle img-bordered-sm"
                      src="https://adminlte.io/themes/v3/dist/img/user1-128x128.jpguser7-128x128.jpg"
                      alt="User Image"
                    />
                    <span class="username">
                      <a href="#">Sarah Ross</a>
